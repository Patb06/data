...
-- augmented gear
DarkRing = {}
DarkRing_A = {name="Dark Ring", augments={'Spell interruption rate down -4%','Phys. dmg. taken -4%','Magic dmg. taken -4%',}} -- table becomes a variable.
DarkRing_B = {name="Dark Ring", augments={'Magic dmg. taken -3','Phys. dmg. taken -5'}} -- table becomes a variable.
...
sets.midcast.Lullaby = {range="Eminent Flute",hands="Brioso Cuffs"}
sets.midcast.Madrigal = {range="Eminent Flute",head="Aoidos' Calot +2"}
sets.midcast.March = {range="Langeleik", hands="Aoidos' Manchettes +2"}
sets.midcast.Minuet = {range="Eminent Flute",body="Aoidos' Hongreline +2"}
sets.midcast.Minne = {range="Syrinx"}
sets.midcast.Mambo = {range="Vihuela"}
sets.midcast.Etude = {range="Langeleik"}
sets.midcast.Paeon = {range="Oneiros Harp",head="Brioso Roundlet +1"}
...
sets.midcast["Sentinel's Scherzo"] = {range="Eminent Flute",feet="Aoidos' Cothrn. +2"}
sets.midcast['Magic Finale'] = {range="Eminent Flute",neck="Incanter's Torque",waist="Corvax Sash",legs="Aoidos' Rhing. +2"}
sets.midcast.Mazurka = {range=info.ExtraSongInstrument}
sets.midcast.Elegy = {range="Syrinx"}
sets.midcast.Threanody = {range="Eminent Flute"}
-- For song buffs (duration and AF3 set bonus)
sets.midcast.SongEffect = {main="Legato Dagger",range="Gjallarhorn",
head="Aoidos' Calot +2",neck="Incanter's Torque",ear2="Loquacious Earring",
body="Aoidos' Hongreline +2",hands="Aoidos' Manchettes +2",ring1="Prolix Ring",
back="Harmony Cape",waist="Corvax Sash",legs="Aoidos' Rhingrave +2",feet="Aoidos' Cothurnes +2"}
-- For song defbuffs (duration primary, accuracy secondary)
sets.midcast.SongDebuff = {main="Marin staff",sub="Mephitis Grip",range="Gjallarhorn",
head="Brioso Roundlet +1",neck="Incanter's Torque",ear1="Psystorm Earring",ear2="Lifestorm Earring",
...
sets.midcast.ResistantSongDebuff = {main="Marin Staff",sub="Mephitis Grip",
head="Nahtirah Hat",neck="Incanter's Torque",ear1="Psystorm Earring",ear2="Lifestorm Earring",
body="Artsieq Jubbah",hands="Aoidos' Manchettes +2",ring1="Perception Ring",ring2="Sangoma Ring",
back="Kumbira Cape",waist="Demonry Sash",legs="Aoidos' Rhingrave +2",feet="Bokwus Boots"}
...
head="Gendewitha Caubeen",neck="Incanter's Torque",
...
body="Artsieq Jubbah",hands="Gendewitha Gages",ring1="Defending Ring",ring2=DarkRing_B,
...
body="Gendewitha Bliaut",hands="Gendewitha Gages",ring1="Defending Ring",ring2=DarkRing_B,
...
head="Aoidos' Calot +2",neck="Wiglen Gorget",ear1="Bloodgem Earring",ear2="Loquacious Earring",
body="Aoidos' Hongreline +2",hands="Aoidos' Manchettes +2",ring1="Defending Ring",ring2=DarkRing_B,
back="Umbra Cape",waist="Flume Belt",legs="Aoidos' Rhingrave +2",feet="Aoidos' Cothurnes +2"}
...
body="Gendewitha Bliaut",hands="Gendewitha Gages",ring1=DarkRing_A,ring2=DarkRing_B,
...
body="Gendewitha Bliaut",hands="Gendewitha Gages",ring1="Defending Ring",ring2=gear.DarkRing_B,
back="Umbra Cape",waist="Flume Belt",legs="Gendewitha Spats",feet="Gendewitha Galoshes"}

...
function init_gear_sets()
    ...
    sets.precast.FC.Cure = set_combine(sets.precast.FC['Healing Magic'], {main="Tamaxchi",sub="Sors Shield",ammo="Impatiens", ear1="Nourishing Earring", ear2="Nourishing Earring +1",legs="Doyen Pants"})
    ...
    sets.midcast.CureSolace = {main="Tamaxchi",sub="Sors Shield",ammo="Incantor Stone",
        head="Gendewitha Caubeen",neck="Incanter's Torque",ear1="Nourishing Earring +1",ear2="Nourishing Earring",
        body="Ebers Briault",hands="Theophany Mitts",ring1="Prolix Ring",ring2="Sirona's Ring",
        back="Tempered Cape",waist=gear.ElementalObi,legs="Orison Pantaloons +2",feet="Piety Duckbills +1"}

    sets.midcast.Cure = {main="Tamaxchi",sub="Sors Shield",ammo="Incantor Stone",
        head="Gendewitha Caubeen",neck="Incanter's Torque",ear1="Nourishing Earring +1",ear2="Nourishing Earring",
        body="Ebers Briault",hands="Bokwus Gloves",ring1="Prolix Ring",ring2="Sirona's Ring",
        back="Tempered Cape",waist=gear.ElementalObi,legs="Orison Pantaloons +2",feet="Piety Duckbills +1"}
    ...
    sets.midcast.Cursna = {main="Bolelabunga",sub="Sors Shield",
        head="Orison Cap +1",neck="Malison Medallion",
        body="Ebers Briault",hands="Hieros Mittens",ring1="Ephedra Ring",ring2="Sirona's Ring",
    ...
    sets.midcast['Enhancing Magic'] = {main="Bolelabunga",sub="Sors Shield",
    ...
    sets.midcast.BarElement = {main="Bolelabunga",sub="Sors Shield",
        head="Orison Cap +1",neck="Incanter's Torque",
        body="Ebers Briault",hands="Orison Mitts +1",
        back="Mending Cape",waist="Olympus Sash",legs="Piety Pantaloons",feet="Orison Duckbills +2"}
    ...
    sets.midcast['Divine Magic'] = {main="Marin Staff",sub="Mephitis Grip",
        head="Nahtirah Hat",neck="Incanter's Torque",ear1="Psystorm Earring",ear2="Lifestorm Earring",
        body="Artsieq Jubbah",hands="Yaoyotl Gloves",ring2="Sangoma Ring",
    ...
    sets.resting = {main=gear.Staff.HMP, 
        body="Nefer Khat",hands="Serpentes Cuffs",
        waist="Austerity Belt",legs="Assiduity pants +1",feet="Serpentes Sabots"}
    

    -- Idle sets (default idle set not needed since the other three are defined, but leaving for testing purposes)
    sets.idle = {main="Bolelabunga", sub="Sors Shield",ammo="Incantor Stone",
        head="Nefer Khat",neck="Twilight Torque",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Heka's Kalasiris",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Dark Ring",
    ...
    sets.idle.PDT = {main="Bolelabunga", sub="Genbu's Shield",ammo="Incantor Stone",
        head="Nefer Khat",neck="Twilight Torque",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Heka's Kalasiris",hands="Gendewitha Gages",ring1="Defending Ring",ring2="Dark Ring",
        back="Cheviot Cape",waist="Witful Belt",legs="Gendewitha Spats",feet="Herald's Gaiters"}
    ...
    sets.idle.Weak = {main="Bolelabunga",sub="Genbu's Shield",ammo="Incantor Stone",
        head="Nefer Khat",neck="Twilight Torque",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Heka's Kalasiris",hands="Serpentes Cuffs",ring1="Defending Ring",ring2="Meridian Ring",
        back="Cheviot Cape",waist="Witful Belt",legs="Assiduity pants +1",feet="Serpentes Sabots"}
    ...
    sets.defense.PDT = {main=gear.Staff.PDT,sub="Achaq Grip",
        ...
        body="Gendewitha Bliaut",hands="Gendewitha Gages",ring1="Defending Ring",ring2="Dark Ring",
    ...
    sets.engaged = {
        ...
        back="Cheviot Cape",waist="Goading Belt",legs="Gendewitha Spats",feet="Gendewitha Galoshes"}

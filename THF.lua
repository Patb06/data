...
function user_setup()
state.OffenseMode:options('Normal', 'Acc', 'Mod', 'Wkr')
...
body="Rawhide Vest",hands="Leyline Gloves",ring1="Rajas Ring",ring2="Epona's Ring",
back="Canny Cape",waist="Fotia Belt",legs="Taeon Tights",feet="Taeon Boots"}
...
sets.precast.WS['Exenterator'].Wkr = set_combine(sets.precast.WS['Exenterator'], {neck="Ygnas Resolve +1"})
...
sets.precast.WS['Dancing Edge'].Wkr = set_combine(sets.precast.WS['Dancing Edge'], {neck="Ygnas Resolve +1"})
...
sets.precast.WS['Evisceration'].Mod = set_combine(sets.precast.WS['Evisceration'], {back="Kayapa Cape",})
sets.precast.WS['Evisceration'].SA = set_combine(sets.precast.WS['Evisceration'].Mod, {})
sets.precast.WS['Evisceration'].TA = set_combine(sets.precast.WS['Evisceration'].Mod, {})
sets.precast.WS['Evisceration'].SATA = set_combine(sets.precast.WS['Evisceration'].Mod, {})
sets.precast.WS['Evisceration'].Wkr = set_combine(sets.precast.WS['Evisceration'], {neck="Ygnas Resolve +1"})
...
sets.precast.WS["Rudra's Storm"].Mod = set_combine(sets.precast.WS["Rudra's Storm"], {back="Kayapa Cape"})
...
body="Pillager's Vest +1",legs="Pillager's Culottes +1"})
sets.precast.WS["Rudra's Storm"].Wkr = set_combine(sets.precast.WS["Rudra's Storm"], {neck="Ygnas Resolve +1"})
...
sets.precast.WS['Shark Bite'].Mod = set_combine(sets.precast.WS['Shark Bite'], {back="Kayapa Cape"})
...
body="Pillager's Vest +1",legs="Pillager's Culottes +1"})
sets.precast.WS['Shark Bite'].Wkr = set_combine(sets.precast.WS['Shark Bite'], {neck="Ygnas Resolve +1"})
...
sets.precast.WS['Mandalic Stab'].Mod = set_combine(sets.precast.WS['Mandalic Stab'], {back="Kayapa Cape"})
...
body="Pillager's Vest +1",legs="Pillager's Culottes +1"})
sets.precast.WS['Mandalic Stab'].Wkr = set_combine(sets.precast.WS['Mandalic Stab'], {neck="Ygnas Resolve +1"})
...
body="Pillager's Vest +1",hands="Pillager's Armlets +1",ring1="Sheltered Ring",ring2="Karieyh Ring",
back="Shadow Mantle",waist="Flume Belt",legs="Pillager's Culottes +1",feet="Fajin Boots"}
sets.idle.Town = {main="Odium", sub="Sabebus",ammo="Thew Bomblet",
head="Pillager's Bonnet +1",neck="Wiglen Gorget",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
body="Pillager's Vest +1",hands="Pill. Armlets +1",ring1="Sheltered Ring",ring2="Karieyh Ring",
...
body="Qaaxo Harness",hands="Pillager's Armlets +1",ring1="Defending Ring",ring2="Karieyh Ring",
...
body="Skadi's Cuirie +1",hands="Pillager's Armlets +1",ring1="Karieyh Ring",ring2="Epona's Ring",
...
head="Felistris Mask",neck="Asperity Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
body="Thaumas Coat",hands="Pillager's Armlets +1",ring1="Karieyh Ring",ring2="Epona's Ring",
back="Atheling Mantle",waist="Patentia Sash",legs="Pillager's Culottes +1",feet="Plunderer's Poulaines +1"}
sets.engaged.Evasion = {ammo="Thew Bomblet",
head="Felistris Mask",neck="Ej Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
body="Qaaxo Harness",hands="Pillager's Armlets +1",ring1="Karieyh Ring",ring2="Epona's Ring",
back="Canny Cape",waist="Patentia Sash",legs="Kaabnax Trousers",feet="Qaaxo Leggings"}
sets.engaged.Acc.Evasion = {ammo="Honed Tathlum",
head="Whirlpool Mask",neck="Ej Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
body="Pillager's Vest +1",hands="Pillager's Armlets +1",ring1="Karieyh Ring",ring2="Epona's Ring",
...
body="Iuitl Vest",hands="Pillager's Armlets +1",ring1="Defending Ring",ring2="Karieyh Ring",

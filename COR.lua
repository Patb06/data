...
sets.precast.CorsairRoll = {head="Lanun Tricorne",hands="Chasseur's Gants",ring1="Barataria Ring"}
...
sets.precast.LuzafRing = {ring2="Barataria Ring"}
sets.precast.FoldDoubleBust = {hands="Lanun Gants"}
sets.precast.CorsairShot = {head="Laksamana's Hat", "Mirke Wardecors"}
...
back="Gunslinger's cape",waist="Impulse Belt",legs="Nahtirah Trousers",feet="Scopuli nails +1"}
-- Weaponskill sets
-- Default set for any weaponskill that isn't any more specifically defined
sets.precast.WS = {
head="Whirlpool Mask",neck="Fotia Gorget",ear1="Bladeborn Earring",ear2="Steelflash Earring",
body="Pursuer's Doublet",hands="Floral Gauntlets",ring1="Rajas Ring",ring2="Epona's Ring",
...
sets.precast.WS['Last Stand'] = {ammo=gear.WSbullet,
    ...
    legs={ name="Herculean Trousers", augments={'Rng.Atk.+28','Weapon skill damage +3%','DEX+10','Rng.Acc.+5',}},
    feet="Skd. Jambeaux +1",
    neck="Iqabi Necklace",
    ...
    back={ name="Mecisto. Mantle", augments={'Cap. Point+47%','Attack+5','DEF+1',}},
}
...
sets.precast.WS['Wildfire'] = {ammo=gear.MAbullet,
    ...
    back={ name="Gunslinger's Cape", augments={'Enmity-2','"Mag.Atk.Bns."+5','"Phantom Roll" ability delay -3','Weapon skill damage +1%',}},
}
...
sets.midcast.CorsairShot['Light Shot'] = {ammo=gear.QDbullet,
    head={ name="Herculean Helm", augments={'Mag. Acc.+16 "Mag.Atk.Bns."+16','"Mag.Atk.Bns."+15',}},
    body={ name="Samnuha Coat", augments={'Mag. Acc.+4','"Mag.Atk.Bns."+5','"Fast Cast"+1',}},
    hands={ name="Herculean Gloves", augments={'Accuracy+2 Attack+2','"Mag.Atk.Bns."+30','Mag. Acc.+15 "Mag.Atk.Bns."+15',}},
    legs={ name="Herculean Trousers", augments={'Mag. Acc.+10 "Mag.Atk.Bns."+10','Weapon skill damage +3%','Mag. Acc.+5','"Mag.Atk.Bns."+13',}},
    feet="Chasseur's Bottes",
    neck="Deviant Necklace",
    waist="Hachirin-no-Obi",
    left_ear="Friomisi Earring",
...
sets.idle.Town = {range="Eminent Gun",ammo=gear.RAbullet,
head="Pursuer's Beret",
neck="Wiglen Gorget",
ear1="Clearview Earring",
ear2="Volley Earring",

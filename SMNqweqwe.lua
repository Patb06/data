...
body="Beckon's Doublet",hands="Glyphic Bracers",ring1="Evoker's Ring",ring2="Fervor Ring",
legs="Marduk's Shalwar +1",feet="Caller's Pigaches +2"}
sets.precast.JA['Mana Cede'] = {hands="Caller's Bracers +2"}
-- Pact delay reduction gear
sets.precast.BloodPactWard = {ammo="Seraphicaller",head="Summoner's Horn",body="Shomonjijoe",hands="Summoner's brazers +2",
back="Samanisi Cape",feet="Glyphic Pigaches"}
...
head="Convoker's Horn",neck="Caller's Pendant",ear1="Gifted Earring",ear2="Evans Earring",
body="Beckoner's Doublet",hands="Glyphic Bracers",ring1="Evoker's Ring",ring2="Fervor Ring",
back="Conveyance Cape",waist="Diabolos's Rope",legs="Marduk's Shalwar +1",feet="Apogee Pumps"}
...
head="Helios Band",neck="Caller's Pendant",ear1="Gifted Earring",ear2="Evans Earring",
body="Beckoner's Doublet",hands="Helios Gloves",ring1="Evoker's Ring",ring2="Fervor Ring",
back="Conveyance Cape",waist="Mujin Obi",legs="Helios Spats",feet="Apogee Pumps"}
...
head="Helios Band",neck="Caller's Pendant",ear1="Gifted Earring",ear2="Evans Earring",
body="Beckoner's Doublet",hands="Helios Gloves",ring1="Evoker's Ring",ring2="Fervor Ring",
back="Conveyance Cape",waist="Diabolos's Rope",legs="Helios Spats",feet="Apogee Pumps"}
...
head="Beckoner's Horn",neck="Wiglen Gorget",ear1="Gifted Earring",ear2="Evans Earring",
body="Hagondes Coat",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Paguroidea Ring",
back="Pahtli Cape",waist="Austerity Belt",legs="Nares Trews",feet="Serpentes Sabots"}

-- Idle sets
sets.idle = {main="Bolelabunga",sub="Genbu's Shield",ammo="Seraphicaller",
head="Beckoner's Horn",neck="Wiglen Gorget",ear1="Gifted Earring",ear2="Evans Earring",
body="Shomonjijoe",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Sangoma Ring",
back="Umbra Cape",waist="Fucho-no-Obi",legs="Nares Trews",feet="Serpentes Sabots"}

sets.idle.PDT = {main=gear.Staff.PDT,sub="Vox Grip",ammo="Seraphicaller",
head="Beckoner's Horn",neck="Twilight Torque",ear1="Gifted Earring",ear2="Evans Earring",
...
head="Beckoner's Horn",neck="Caller's Pendant",ear1="Gifted Earring",ear2="Evans Earring",
body="Beckoner's Doublet",hands="Serpentes Cuffs",ring1="Evoker's Ring",ring2="Fervor Ring",
back="Conveyance Cape",waist="Fucho-no-Obi",legs="Helios Spats",feet="Apogee Pumps"}

sets.idle.PDT.Avatar = {main="Gridarvor",sub="Vox Grip",ammo="Seraphicaller",
head="Beckoner's Horn",neck="Caller's Pendant",ear1="Gifted Earring",ear2="Evans Earring",
...
sets.idle.Spirit = {main="Gridarvor",sub="Vox Grip",ammo="Seraphicaller",
head="Beckoner's Horn",neck="Caller's Pendant",ear1="Gifted Earring",ear2="Evans Earring",
body="Beckoner's Doublet",hands="Serpentes Cuffs",ring1="Evoker's Ring",ring2="Sangoma Ring",
back="Samanisi Cape",waist="Fucho-no-Obi",legs="Summoner's Spats",feet="Herald's Gaiters"}

sets.idle.Town = {main="Gridarvor",sub="Vox grip",ammo="Seraphicaller",
head="Beckoner's Horn",neck="Wiglen Gorget",ear1="Gifted Earring",ear2="Evans Earring",
body="Beckoner's Doublet",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Sangoma Ring",
...
sets.idle.Avatar.Melee = {hands="Regimen Mittens",back="Samanisi Cape",waist="Moepapa Stone",legs="Helios Spats"}
sets.perp = {main="Gridarvor",sub="Vox Grip",ammo="Seraphicaller",
head="Beckoner's Horn",neck="Caller's Pendant",ear1="Gifted Earring",ear2="Evans Earring",
body="Beckoner's Doublet",hands="Serpentes Cuffs",ring1="Evoker's Ring",ring2="Fervor Ring",
back="Conveyance Cape",waist="Fucho-no-Obi",legs="Helios Spats",feet="Apogee Pumps"}
...
sets.perp.Day = {body="Beckoner's Doublet",hands="Caller's Bracers +2"}
sets.perp.Weather = {neck="Caller's Pendant",body="Beckoner's Doublet",hands="Caller's Bracers +2"}
-- Carby: Mitts+Conv.feet = 1/tick perp. Everything else should be +refresh
sets.perp.Carbuncle = {main="Bolelabunga",sub="Genbu's Shield",ear1="Gifted Earring",ear2="Evans Earring",
head="Convoker's Horn",body="Hagondes Coat",hands="Carbuncle Mitts",legs="Nares Trews",feet="Apogee Pumps"}
...
head="Hagondes Hat",neck="Wiglen Gorget",ear1="Gifted Earring",ear2="Evans Earring",
...
sets.defense.MDT = {
head="Hagondes Hat",neck="Twilight Torque",ear1="Gifted Earring",ear2="Evans Earring",
